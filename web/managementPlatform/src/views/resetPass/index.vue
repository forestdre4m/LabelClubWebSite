...
<script>
	...
	import {changpaiUpdatePassword} from "@/api/changpai/changpaiApi";	import {yinlerenUpdatePassword} from "@/api/yinleren/yinlerenApi";	
				...
				this.$refs[editData].validate(valid => {
					if (valid) {
						if (this.editForm.newPassword === this.editForm.newPassword2) {
							...
							}else if (this.userInfo.roles[0] == 'yinleren') {
